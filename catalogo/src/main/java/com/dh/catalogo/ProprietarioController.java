...
//    private ResponseEntity<List<MovieDTO>> pesquisarCarrosPorProprietario(@PathVariable String nomeMovie) {
//        return ResponseEntity.ok(service.pesquisarMovie(nomeMovie));
//    }
//}
